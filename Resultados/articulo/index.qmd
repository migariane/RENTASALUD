...
We looked at the relationship between average income and life expectancy across the eight provinces using three approaches: simple correlation (Pearson and Spearman), hierarchical clustering (to see which provinces group together), and a flexible statistical model (GAM) that can detect curved, non-linear relationships. These analyses are exploratory — with only eight provinces, we have limited ability to detect patterns.
...
If cancer were eliminated, men would gain about 3.9 years of life expectancy and women about 2.8 years (Table 2). For women, eliminating heart disease would have a similar effect (2.9 years). Together, cancer and heart disease account for roughly 7 years of potential gain for men and 6 for women — the two biggest targets for prevention.
...
All the results above are available in an interactive R Shiny application with five tabs:
